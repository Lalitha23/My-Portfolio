  ...
  return (
    <div className={cls} style={{ left: `${posX}px` }} aria-hidden="true">
      ...
      >
        ...
        <rect x="22" y="6" width="4" height="3" fill="#1B2A4A" />

        {/* Head */}
        <rect x="8" y="9" width="32" height="18" fill="#1B2A4A" />
        {/* Face screen */}
        ...
        {/* Body */}
        <rect x="6" y="27" width="36" height="16" fill="#1B2A4A" />
        {/* Chest buttons */}
        ...
        <g className={styles.leftArm}>
          <rect x="0" y="27" width="6" height="10" fill="#1B2A4A" />
        </g>
        ...
        {showClipboard ? (
          <g className={styles.clipboardGroup}>
            {/* Arm raised */}
            <rect x="42" y="21" width="6" height="10" fill="#1B2A4A" />
            {/* Clipboard body */}
            <rect x="48" y="18" width="13" height="17" fill="#FFD700" rx="1" />
            {/* Clip holder */}
            <rect x="52" y="16" width="5" height="4" fill="#1B2A4A" rx="1" />
            {/* Notes lines */}
            <rect x="50" y="25" width="9" height="1.5" fill="#1B2A4A" />
            <rect x="50" y="28.5" width="7" height="1.5" fill="#1B2A4A" />
            <rect x="50" y="32" width="8" height="1.5" fill="#1B2A4A" />
          </g>
        ) : (
          <g className={styles.rightArm}>
            <rect x="42" y="27" width="6" height="10" fill="#1B2A4A" />
          </g>
        )}

        {/* Left leg */}
        <g className={styles.leftLeg}>
          <rect x="12" y="43" width="10" height="13" fill="#1B2A4A" />
        </g>

        {/* Right leg */}
        <g className={styles.rightLeg}>
          <rect x="26" y="43" width="10" height="13" fill="#1B2A4A" />
        </g>
      </svg>
    </div>
  );
